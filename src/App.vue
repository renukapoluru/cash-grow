...
.profile-page .user-card .user-image {
    height: 70px;
    width: 70px;
    border-radius: 100%;
...
.profile-page .card.logout {
    color: red;
    font-weight: 600;
}

.profile-page .card.logout a {
  color:inherit;
}
...
.profile-page .funds > .column {
    width: 50%;
}

.profile-page .funds h4 {
    font-size: 20px;
    font-weight: 600;
    margin: 0;
}

.profile-page .funds h5 {
    font-size: 16px;
    margin-top: 5px;
    margin: 3px 0 0;
    opacity: 0.5;
